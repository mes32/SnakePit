...
class LoadMenu():
    ...
    def _display(self):
        ...
        self._note_text("")
        self._note_text("Use arrows keys to select a game to load. Press ESC to cancel.")
        pygame.display.flip()
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if k == pygame.K_ESCAPE:
                        ...
                        if self.selected in range(self.NUM_SLOTS):
                            if os.path.exists(self.SAVE_SLOTS[self.selected]):
                                fh = open(self.SAVE_SLOTS[self.selected], 'rb')
